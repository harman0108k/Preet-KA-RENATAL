...
function AdminDefaultLayout(props) {
  ...
  return (
    ...
    <AiFillHome className="mr-2" /><a class="mr-5 hover:text-gray-900 text-gray-600 text-black" href="/admin">Admin Home</a>
      {/* <a class="mr-5 hover:text-gray-900 text-gray-600 text-black" href="/userbookings">Bookings</a> */}
      <FaUser/><button class="mr-5 hover:text-gray-900 text-gray-600 text-black" >{admin.username}</button>
    </nav>
